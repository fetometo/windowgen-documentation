...
2. The button will turn into progress bar, indicating that Blender is loading all the necessary components into your scene. This process takes 5-10 seconds.
...
2. The button will turn into progress bar, indicating that Blender is updating all the necessary components. This process takes 5-10 seconds.

    .. image:: images/02_working_with_04loading.png
        :width: 50%

3. Once the upgrade is completed, the UI will return to it's default state.
...
2. When Selected Face option is chosen. Before adding the window, enter Edit Mode (Tab) and select a Face or an Edge Loop you want your window to be placed at. After you made seletion go back to the Object Mode (Tab). And add the window (see the next step).
